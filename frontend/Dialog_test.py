...
class Ui_dialog(object):
    ...
    def retranslateUi(self, dialog):
        ...
        self.lineEdit_addhost.setText(_translate("dialog", "hello"))
        self.label_hostname.setText(_translate("dialog", "Hostname:"))
        self.lineEdit_addIP.setText(_translate("dialog", "world"))
        self.label_IP.setText(_translate("dialog", "IP :"))
        self.lineEdit_addMAC.setText(_translate("dialog", "good"))
